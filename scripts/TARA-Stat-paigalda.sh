...
# TARA-Stat-paigalda.sh paigaldab logibaasi (MongoDB) ja
...
if [ "$?" = 0 ]; then 
  ...
  echo "Node.js paigaldamise 1. samm ebaõnnestus"
  exit
fi
...
# Eemalda Node.js teegid, kuid neid peaks olema
